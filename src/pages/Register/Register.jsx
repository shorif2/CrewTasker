 ...
 <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
     <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
         ...
         <form onSubmit={handleSignUp} className="space-y-4 md:space-y-6" action="#">
             ...
             <button type="submit" className="w-full bg-red-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center text-white">Sign Up</button>
             <NavLink to='/login' className="text-sm font-light text-gray-500 dark:text-gray-400">
